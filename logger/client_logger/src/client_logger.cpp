...
client_logger::client_logger(std::string format) : _format(std::move(format))
{
...
void client_logger::add_console_stream_to_set(
...
logger const *client_logger::log(
    ...
    while (it_map != _streams.end()) {
        ...
        if (it_set != (*it_map).second.second.end()) {
            ...
            client_logger::print_with_flags_to_file_stream(out_stream, format,
                                                           text, severity);
        }
        ++it_map;
    }
